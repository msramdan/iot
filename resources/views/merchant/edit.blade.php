                    ...
                    <div class="card-body">
                        <form action="{{ route('merchant.update', $merchant->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="address1" id="address1" class="form-control @error('address1') is-invalid @enderror" placeholder="" autocomplete="off">
                                {{ old('address1') ?  old('address1') : $merchant->address1 }}
                                </textarea>
                                @error('address1')
                                <span style="color: red;">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="address2" id="address2" class="form-control @error('address2') is-invalid @enderror" placeholder="" autocomplete="off">
                                {{ old('address2') ?  old('address2') : $merchant->address2 }}
                                </textarea>
                                @error('address2')
                                <span style="color: red;">{{ $message }}</span>
                                @enderror
                           ...
                           <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="note" id="note" class="form-control @error('note') is-invalid @enderror" placeholder="" value="{{ old('note') }}" autocomplete="off">{{ old('note') ?  old('note') : $merchant->note }}</textarea>
                                @error('note')
                                <span style="color: red;">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <small>Isi password untuk mengubah password</small>
                                @error('password')
                                <span style="color: red;">{{ $message }}</span>
                                @enderror
                            </div>
