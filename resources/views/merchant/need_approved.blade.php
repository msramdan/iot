      ...
      <div class="modal-body">
        ...
        <div class="text-center">
            <div class="btn-group mr-3">
                <button class="btn btn-success mr-2 mt-3" id="merchant-approve1-btn" type="button">Approve 1</button>
                <button class="btn btn-danger mr-2 mt-3" id="merchant-reject-approve1-btn" type="button">Reject Approve 1</button>
            </div>
            <div class="btn-group ml-2">
                 <button class="btn btn-success ml-2 mt-3" id="merchant-approve2-btn" type="button">Approve 2</button>
                 <button class="btn btn-danger mr-2 mt-3" id="merchant-reject-approve1-btn" type="button">Reject Approve 2</button>
            </div>
        </div>
      </div>
