                                                ...
                                                <div class="col-md-3 col-md-6">
                                                    <div>
                                                        ...
                                                        <input type="number" step="0.01"
                                                            ...
                                                            name="mdr" id="mdr" placeholder="" value="{{ old('mdr') }}"
                                                            autocomplete="off">
                                                        @error('mdr')
                                                        <span style="color: red;">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col-md-3 col-md-6">
                                                    <div>
                                                        ...
                                                        <select name="provinsi_id" id="provinsi" class="form-control">
                                                            ...
                                                            <option value="{{ $province->id }}">{{ $province->provinsi
                                                                }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-md-3 col-md-6">
                                                    <div>
                                                        ...
                                                        <textarea name="address1" id="address1" rows="3"
                                                            ...
                                                            autocomplete="off">{{ old('address1') }}</textarea>
                                                        @error('address1')
                                                        <span style="color: red;">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-3 col-md-6">
                                                    <div>
                                                        ...
                                                        <textarea name="address2" id="address2" rows="3"
                                                            ...
                                                            placeholder="" value="{{ old('address2') }}"
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="row gy-3">
                                                        ...
                                                        <div class="col-md-3 col-md-6 merchant-bussiness d-none">
                                                            <div>
                                                                <label for="basiInput" class="form-label">Akta Pendirian
                                                                    Perusahaan</label>
                                                        ...
                                                        <div class="col-md-3 col-md-6 merchant-bussiness d-none">
                                                            <div>
                                                                <label for="basiInput" class="form-label">Akta Pengurus
                                                                    Perusahaan</label>
                                                    ...
                                                    <div class="row gy-3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <select
                                                                    ...
                                                                    <option value="{{ $rekening->id }}" {{
                                                                        old('rek_pooling_id')==$rekening->id ?
                                                                        'selected' : ''}}>{{ $rekening->rek_pooling_code
                                                        ...
                                                        <div class="col-md-3 col-md-6">
                                                            <div>
                                                                ...
                                                                <select class="form-control @error('bank_id') @enderror"
                                                        ...
                                                        <div class="col-md-3 col-md-6">
                                                            <div>
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    name="account_name" id="account_name" placeholder=""
                                                        ...
                                                        <div class="col-md-3 col-md-6">
                                                            <div>
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    placeholder="" value="{{ old('number_account') }}"
                                                                    autocomplete="off">
