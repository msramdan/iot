            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                <input type="hidden" name="invoice_number" value="{{ $id }}">
                                <label for="">Period</label>
                                <input type="datetime-local" name="period" id="period" value="{{ old('period') }}" class="form-control @error('period') is-invalid @enderror">
                                @error('period')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control c" step="0.01" name="grand_total" id="grand_total" value="{{ old('grand_total') }}">
                                @error('grand_total')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
