...
@section('title', 'Detail Smart Power Meter')
@section('content')
    <style>
        .my-custom-scrollbar {
            position: relative;
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Detail Smart Power Meter : {{ $devEUI }} </h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Detail Smart Power Meter</li>
                            </ol>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('master_power_meter.index') }}" style="" class="btn btn-md btn-warning">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <center>
                                ...
                                @else
                                    <h4>Status Switch : <span
                                            class="badge rounded-pill badge-outline-dark">{{ $lastData->status_switch }}</span>
                                    </h4>
                                @endif
...
@push('js')
    ...
    <script>
        ...
        Highcharts.chart('chart-container', {
            ...
            title: {
                text: 'Voltage {{ $devName }} <br> {{ $devEUI }}'
            },
            subtitle: {
                text: "{{ date('d M Y', strtotime($start_dates)) }} - {{ date('d M Y', strtotime($end_dates)) }}"
            },
    ...
    <script>
        ...
        Highcharts.chart('chart-container3', {
            ...
            title: {
                text: 'Frequency’s PLN {{ $devName }} <br> {{ $devEUI }}'
            },
            subtitle: {
                text: "{{ date('d M Y', strtotime($start_dates)) }} - {{ date('d M Y', strtotime($end_dates)) }}"
            },
