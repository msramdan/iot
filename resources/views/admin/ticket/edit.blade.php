                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="">Preview Image 1</label>
                                        <img src="{{ asset('storage/' . $ticket->image_1 )}}" alt="" class="img-fluid" id="output1">
                                    </div>
                                    <div class="col-6">
                                        <label for="">Preview Image 2</label>
                                        <img src="{{ asset('storage/' . $ticket->image_2 )}}" alt="" class="img-fluid" id="output2">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
