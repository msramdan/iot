                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status" id="status_ticket" class="form-select @error('status') is-invalid @enderror">
                                    ...
                                    <option value="need confirmation" {{ old('status') == 'need confirmation' ? 'selected' : '' }}>Need Confirmation</option>
                            ...
                            <div class="form-group">
                                <a href="{{ route('tickets.index') }}" class="btn btn-warning"><i class="mdi mdi-arrow-left-thin"></i> Back</a>
