                    ...
                    <div class="card-body">
                        <form action="{{ route('province.update', $province->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('provinsi') is-invalid @enderror" name="provinsi" id="provinsi" placeholder="" value="{{ old('provinsi') ? old('provinsi') : $province->provinsi }}" autocomplete="off">
                                @error('provinsi')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('ibukota') is-invalid @enderror" name="ibukota" id="ibukota" placeholder="" value="{{ old('ibukota') ? old('ibukota') : $province->ibukota }}" autocomplete="off">
                                @error('ibukota')
                                <span style="color: red;">{{ $message }}</span>
                                @enderror
                            </div>
