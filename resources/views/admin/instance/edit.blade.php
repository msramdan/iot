                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('instance.index') }}">Instances</a></li>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="instance_code" id="instance_code" placeholder=""
                                                value="{{ old('instance_code') ? old('instance_code') : $instance->instance_code }}"
                                                autocomplete="off">
                                            @error('instance_code')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="instance_name" id="instance_name" placeholder=""
                                                value="{{ old('instance_name') ? old('instance_name') : $instance->instance_name }}"
                                                autocomplete="off">
                                            @error('instance_name')
                                                <span style="color: red;">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                class="form-control @error('inspush_urltance_name') is-invalid @enderror"
                                                name="push_url" id="push_url" placeholder=""
                                                value="{{ old('push_url') ? old('push_url') : $instance->push_url }}"
                                                autocomplete="off">
                                            @error('push_url')
                                                <span style="color: red;">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('username') ? old('username') : $instance->username }}"
                                                autocomplete="off">
                                            @error('username')
                                                <span style="color: red;">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                                ...
                                                value="{{ old('phone') ? old('phone') : $instance->phone }}"
                                                autocomplete="off">
                                            @error('phone')
                                                <span style="color: red;">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('email') is-invalid @enderror"
                                                ...
                                                value="{{ old('email') ? old('email') : $instance->email }}"
                                                autocomplete="off">
                                            @error('email')
                                                <span style="color: red;">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            <div>
                                                ...
                                                <select name="bussiness_id" id="bussiness" class="form-control">
                                                    <option value="">-- Select --</option>
                                                    @foreach ($bussinesses as $bussiness)
                                                        <option value="{{ $bussiness->id }}"
                                                            {{ $instance->bussiness_id == $bussiness->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                                ...
                                                <select name="province_id" id="provinsi" class="form-control">
                                                    ...
                                                    @foreach ($provinces as $province)
                                                        <option value="{{ $province->id }}"
                                                            {{ $province->id == $instance->province_id ? 'selected' : '' }}>
                                                ...
                                                <select name="city_id" id="kota" class="form-control">
                                                    ...
                                                    @foreach ($city as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ $item->id == $instance->city_id ? 'selected' : '' }}>
                                                ...
                                                <select name="district_id" id="kecamatan" class="form-control">
                                                    ...
                                                    @foreach ($district as $kecamatan)
                                                        <option value="{{ $kecamatan->id }}"
                                                            {{ $kecamatan->id == $instance->district_id ? 'selected' : '' }}>
                                                ...
                                                <select name="village_id" id="kelurahan" class="form-control">
                                                    ...
                                                    @foreach ($village as $kelurahan)
                                                        <option value="{{ $kelurahan->id }}"
                                                            {{ $kelurahan->id == $instance->village_id ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            <div>
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('zip_code') ? old('zip_code') : $instance->zip_code }}"
                                                    autocomplete="off">
                                        ...
                                        <div class="mb-3">
                                            <div>
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('latitude') ? old('latitude') : $instance->latitude }}"
                                                    autocomplete="off">
                                        ...
                                        <div class="card px-2 py-1">
                                            <div class="mb-3 search-box">
                                                ...
                                                @enderror
                                                <ul class="results">
                                                    <li style="text-align: center;padding: 50% 0; max-height: 25hv;">
                                                        Masukan Pencarian</li>
                                                </ul>
                                            </div>
