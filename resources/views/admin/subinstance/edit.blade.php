...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{ route('instance.subinstance.update', [$subinstance->instance_id, $subinstance->id]) }}"
                method="post">
                @csrf
                @method('PUT')
                <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="code_subinstance" id="code_subinstance"
                                                value="{{ old('code_subinstance') ?? $subinstance->code_subinstance }}"
                                                class="form-control @error('code_subinstance') is-invalid @enderror "
                                                readonly>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name_subinstance" id="name_subinstance"
                                                value="{{ old('name_subinstance') ?? $subinstance->name_subinstance }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @forelse ($setting_water_tolerances as $s => $water_tolerance)
                                                <div class="row">
                                                    <input type="hidden" name="device_tolerance_id[]"
                                                        value="{{ $water_tolerance->id }}">
                                                    <input type="hidden" name="type_device[]"
                                                        value="{{ $water_tolerance->type_device }}">
                                                    <div class="col-md-4">
                                                        <label for="temperatur_tolerance">Field</label>
                                                        <input type="text" class="form-control" name="field_data[]"
                                                            readonly value="{{ $water_tolerance->field_data }}">
                                                        @error('field_data.{{ $s }}')
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="number" step="any" class="form-control"
                                                            name="min_tolerance[]"
                                                            value="{{ old("min_tolerance.{$s}") ? old("min_tolerance.{$s}") : $water_tolerance->min_tolerance }}">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="number" step="any" class="form-control"
                                                            name="max_tolerance[]"
                                                            value="{{ old("max_tolerance.{$s}") ? old("max_tolerance.{$s}") : $water_tolerance->max_tolerance }}">
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            @forelse ($setting_power_tolerances as $p => $power_tolerance)
                                                ...
                                                <div class="row">
                                                    <input type="hidden" name="device_tolerance_id[]"
                                                        value="{{ $power_tolerance->id }}">
                                                    <input type="hidden" name="type_device[]"
                                                        value="{{ $power_tolerance->type_device }}">
                                                    <div class="col-md-4">
                                                        <label for="temperatur_tolerance">Field</label>
                                                        <input type="text" class="form-control" name="field_data[]"
                                                            readonly value="{{ $power_tolerance->field_data }}">
                                                        @error('field_data.{{ $p }}')
                                                            <span style="color: red;">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="number" step="any" class="form-control"
                                                            name="min_tolerance[]"
                                                            value="{{ old("min_tolerance.{$p}") ? old("min_tolerance.{$p}") : $power_tolerance->min_tolerance }}">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="number" step="any" class="form-control"
                                                            name="max_tolerance[]"
                                                            value="{{ old("max_tolerance.{$p}") ? old("max_tolerance.{$p}") : $power_tolerance->max_tolerance }}">
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            @forelse ($setting_gas_tolerances as $g => $gas_tolerance)
                                                ...
                                                <div class="row">
                                                    <input type="hidden" name="device_tolerance_id[]"
                                                        value="{{ $gas_tolerance->id }}">
                                                    <input type="hidden" name="type_device[]"
                                                        value="{{ $gas_tolerance->type_device }}">
                                                    <div class="col-md-4">
                                                        <label for="temperatur_tolerance">Field</label>
                                                        <input type="text" class="form-control" name="field_data[]"
                                                            readonly value="{{ $gas_tolerance->field_data }}">
                                                        @error('field_data.{{ $g }}')
                                                            <span style="color: red;">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="number" step="any" class="form-control"
                                                            name="min_tolerance[]"
                                                            value="{{ old("min_tolerance.{$g}") ? old("min_tolerance.{$g}") : $gas_tolerance->min_tolerance }}">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="number" step="any" class="form-control"
                                                            name="max_tolerance[]"
                                                            value="{{ old("max_tolerance.{$g}") ? old("max_tolerance.{$g}") : $gas_tolerance->max_tolerance }}">
                                            ...
                                            @empty
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label for="tegangan">Field</label>
                                                        <input type="text" class="form-control" name="field_data[]"
                                                            readonly value="purchase_remain">
                                                        @error('field_data.4')
                                                            <span style="color: red;">{{ $message }}</span>
                                                        @enderror
                                                    </div>
