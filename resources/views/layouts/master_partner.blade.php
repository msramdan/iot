                    ...
                    <form method="POST" action="{{ route('instances.change_password') }}">
                        ...
                        <div class="modal-body">
                            <div class="form-group mb-3">
                                ...
                                <input id="password" class="form-control @error('old_password') is-invalid @enderror"
                                    name="old_password" type="password" pattern="^\S{8,}$"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input id="password" class="form-control @error('password') is-invalid @enderror"
                                    name="password" type="password" pattern="^\S{8,}$"
                                    onchange="this.setCustomValidity(this.validity.patternMismatch ? 'Minimal 6 Karakter' : ''); if(this.checkValidity()) form.passcon.pattern = this.value;"
                                    placeholder="Password Baru" required>
                                @error('password')
                                    <span style="color: red;">{{ $message }}</span>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('password_confirmation') is-invalid @enderror"
                                    id="passcon" name="password_confirmation" type="password" pattern="^\S{6,}$"
