            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown <?= request()->segment(2) == 'merchant' ? 'show' : '' ?>" id="sidebarIconsMerchant">
                    <ul class="nav nav-sm flex-column">
                        ...
                        @can('merchant_show')
                        <li class="nav-item">
                            <a href="{{ route('merchant.approval') }}" class="nav-link <?= request()->segment(2) == 'merchant' && request()->segment(3) == 'approval'   ? 'active' : '' ?>  " data-key="t-remix">Merchants Need Approval <span class="badge badge-pill bg-danger" data-key="t-new">Data</span></a>
                        </li>
                        @endcan
                        @can('merchant_show')
                        <li class="nav-item">
