<div id="scrollbar">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link menu-link {{ set_active('home') }}" href="{{ route('instances.dashboard') }}"
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown {{ set_show(['master_water_meter*', 'master_power_meter*', 'master_gas_meter*']) }}"
                    ...
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('instances.master_water_meter.index') }}"
                                class="nav-link {{ set_active(['master_water_meter*']) }}" data-key="t-remix">Latest
                                Data Water Meter</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('instances.master_power_meter.index') }}"
                                class="nav-link {{ set_active(['master_power_meter*']) }}" data-key="t-remix">Latest
                                Data Power Meter</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('instances.master_gas_meter.index') }}"
            ...
            <li class="nav-item">
                <a class="nav-link menu-link {{ set_active('device.*') }}"
                    href="{{ route('instances.subinstance.index') }}" role="button" aria-expanded="false"
            ...
            <li class="nav-item">
                <a class="nav-link menu-link {{ set_active('device.*') }}"
                    href="{{ route('instances.device.index') }}" role="button" aria-expanded="false"
                    aria-controls="sidebarDashboards">
                    <i class="mdi mdi-devices"></i> <span data-key="t-dashboards">Device</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link menu-link {{ set_active('instances.tickets') }}"
                    href="{{ route('instances.tickets.index') }}" role="button" aria-expanded="false"
                    aria-controls="sidebarDashboards">
