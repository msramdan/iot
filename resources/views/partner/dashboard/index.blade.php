...
@section('content')
                                ...
                                <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                    <div class="flex-grow-1">
                                        <h4 class="fs-16 mb-1">Welcome,
                                            {{ Auth::guard('instances')->user()->instance_name }}</h4>
                                    </div>
                                </div><!-- end card header -->
                            </div>
                            <!--end col-->
    ...
    <div class="modal fade" id="modalListDevice" tabindex="-1" aria-labelledby="modalListDeviceLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalListDeviceLabel">Total Device</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="table-responsive">
    ...
    <script>
        $(document).ready(function() {
            ...
            function getToLoc(lat, lng, getLocationMap, id, instance_name) {
                const zoom = 17;
                var url_edit = "{{ url('/instance/') }}/" + id + "/edit";
                $.ajax({
