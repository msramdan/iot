                            ...
                            <div class="text-center">
                                <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                    @if (auth()->user('instances')->photo == null)
                                        <img class="rounded-circle avatar-xl img-thumbnail user-profile-image  shadow"
                                            src="{{ asset('frontend/default.png') }}" alt="user-profile-image">
                                    @else
                                        <img class="rounded-circle avatar-xl img-thumbnail user-profile-image  shadow"
                                    ...
                                    <div class="avatar-xs p-0 rounded-circle profile-photo-edit">
                                        <form action="" method="POST" enctype="multipart/form-data" id="form-profile">
                                            ...
                                            <input id="profile-img-file-input" type="file" class="profile-img-file-input"
                                                name="photo" onchange="readUrl(this, '#photo-profile')">
