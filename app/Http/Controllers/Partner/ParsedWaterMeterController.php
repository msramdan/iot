...
class ParsedWaterMaterController extends Controller
{
    public function index(Request $request)
    {
        ...
        if(request()->ajax()){
            $parsed_data = ParsedWaterMater::with('rawdata')->with(['device' => function($q) use($instance) {
        ...
        return view('partner.parsed_rawdata.parsed_water_meter.index', compact('devices'));
    }
