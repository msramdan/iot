...
class ParsedPowerMeterController extends Controller
{
    public function index(Request $request)
    {
        ...
        if(request()->ajax()){
            $parsed_data = ParsedPowerMater::with('rawdata')->with(['device' => function($q) use($instance) {
        ...
        return view('partner.parsed_rawdata.parsed_power_meter.index', compact('devices'));
    }
}
